    ...
    <Container fluid="lg">
      <Row className="my-4">
        <Col className="ms-4 text-center">
          ...
          <a className="btn btn-primary me-2" href="https://www.linkedin.com/in/derrick-fleming/">
            <span className="fa-brands fa-linkedin me-2"></span>LinkedIn
          </a>
          <a className="btn btn-secondary me-2" href="https://github.com/derrick-fleming">
