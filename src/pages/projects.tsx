    ...
    <Container fluid="lg animate">
      ...
      <Row className="py-2 justify-content-center">
        <Col sm={6} md={6} lg={5} className="animate glow delay-2">
          <Card className="mx-4 mb-4 shadow-lg border border-5 border-magenta bg-dark">
            ...
            <Card.Footer className="open-sans border-magenta border-2">
              ...
              <a className="btn btn-primary btn-magenta me-2 my-2 fs-5" href="http://park-advisor.derrickfleming.com/">
        ...
        <Col sm={6} md={6} lg={5} className="animate glow delay-3">
          <Card className="mx-4 shadow-lg border border-5 border-magenta bg-dark">
            ...
            <Card.Footer className="open-sans border-magenta border-2">
              ...
              <a className="btn btn-primary btn-magenta fs-5 me-2 my-2" href="https://derrick-fleming.github.io/my-villagers/">
                <i className="fa-solid fa-globe pe-1"></i>Website
              </a>
            </Card.Footer>
          </Card>
